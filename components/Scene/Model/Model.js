...
const material = new THREE.MeshToonMaterial({
    color: new THREE.Color('#292c2e').convertSRGBToLinear(),

    // gradientMap: 'threeTone',
})
export default function Model(props) {
    const group = useRef()
    const { nodes } = useGLTF('/models/pink-d.glb')
    return (
        <group ref={group} {...props} dispose={null}>
            <Reflector
                ...
                args={[70, 70]}>
                {(Material, props) => <Material metalness={0.25} color="#808080" roughness={1} {...props} />}
            </Reflector>
